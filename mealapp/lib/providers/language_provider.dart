...
class LanguageProvider with ChangeNotifier {
  ...
  onchangeLanguage(bool val) async {
    SharedPreferences preferenceslan = await SharedPreferences.getInstance();
    preferenceslan.setBool('lan', val);
    notifyListeners();
    isEN = val;
    notifyListeners();
  }
  ...
  Map<String?, Object?> textsAr = {
    "chooseColorFilter": "تغيير ألوان التطبيق",
    "start": "أبدأ الان",
    ...
    "Challenging": "متوسطة",
    "Hard": "صعبة",
    "Affordable": "غير مكلفة",
    "Pricey": "مكلفة",
    "Luxurious": "باهضة الثمن",
    "min": "دقيقة",
    "min2": "دقائق",
  ...
  Map<String?, Object?> textsEn = {
    "chooseColorFilter": "Change application colors",
    "start": "GET STARTED",
  ...
  Object? returntext(String text) {
    return isEN ? textsEn[text] : textsAr[text];
  }

  getDataLanguage() async {
    SharedPreferences preferenceslan = await SharedPreferences.getInstance();
    isEN = preferenceslan.getBool('lan') ?? true;
    notifyListeners();
  }
}
